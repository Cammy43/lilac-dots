...
-- hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = desktopSwitchSpeed, bezier = "quick", style = "slide" })
-- hl.animation({ leaf = "workspacesOut", enabled = true,  speed = desktopSwitchSpeed, bezier = "quick", style = "slide" })
hl.animation({
    leaf = "zoomFactor",
    enabled = true,
    speed = 7,
...
hl.gesture({
    ...
    action = function()
        hl.notification.create({
            text = "lilac::gesture::overview(): not implemented",
            timeout = 2000,
            icon = "err"
        })
    end
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("hyprmenu"))
...
-- change volume by one while holding shift
...
-- change brightness by one while holding shift
hl.bind("SHIFT + XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl set 1%+"), {
    locked = true,
    repeating = true
})
...
if hl_isLaptop then
    hl.bind("switch:on:Lid Switch", hl.dsp.exec_cmd(basePath .. "lilac/lockstate 1"), {
        locked = true
    })

    -- Exit lock screen
    hl.bind("switch:off:Lid Switch", hl.dsp.exec_cmd(basePath .. "lilac/lockstate 0"), {
        locked = true
    })
end
